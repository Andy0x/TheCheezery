...
class ProductosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var listaVieta: ListView = findViewById(R.id.listView) as ListView

        var adapatador: AdaptorProductos = AdaptorProductos(this, coldDrinks)
        listaVieta.adapter = adapatador
